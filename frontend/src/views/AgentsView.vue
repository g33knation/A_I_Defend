...
<template>
  <div class="relative min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-slate-100">
    ...
    <div class="relative px-4 py-6 lg:px-8 mx-auto max-w-[1600px]">
      ...
      <div v-else-if="!isLoading" class="mt-12 text-center rounded-2xl border border-white/10 bg-white/5 py-10 max-w-sm mx-auto">
        ...
        <h3 class="mt-3 text-sm font-semibold text-white">No agents registered</h3>
        <p class="mt-1 text-xs text-slate-400">Scanner agents will appear here once they register with the control plane.</p>
      </div>
