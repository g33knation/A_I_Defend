...
<template>
  <div class="p-4 max-w-[1600px] mx-auto">
    ...
    <!-- Empty state -->
    <div v-if="filteredEvents.length === 0" class="text-center py-8 bg-white rounded-lg border border-gray-200 max-w-sm mx-auto">
      <svg class="mx-auto h-9 w-9 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M9.172 16.172a4 4 0 015.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
      </svg>
      <h3 class="mt-2 text-xs font-semibold text-gray-900">No events found</h3>
